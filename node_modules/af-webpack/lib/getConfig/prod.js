...
function mergeConfig(config, userConfig) {
  ...
  } else if ((0, _isPlainObject.default)(userConfig)) {
...
function _default(webpackConfig, opts) {
  ...
  if (disableCompress || process.env.__FROM_UMI_TEST) {
    ...
    webpackConfig.optimization.minimizer([new _uglifyjsWebpackPlugin.default(mergeConfig(_objectSpread({}, _uglifyOptions.default, {
